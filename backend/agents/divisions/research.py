...
RESEARCH_DIVISION: list[AgentProfile] = [
    ...
    AgentProfile(
        id="academic_paper_summarizer", name="Academic Paper Summarizer",
        role="Paper Summarization", tier=2, connector_type="internal",
        description="Reads and summarizes academic papers into concise, actionable executive briefs",
        capabilities=[
            _cap("paper_search", "Search and retrieve relevant academic papers"),
            _cap("summarization", "Distill papers into key findings, methods, and implications"),
            _cap("research", "Critically evaluate paper quality, sample size, and reproducibility"),
            _cap("knowledge_synthesis", "Aggregate findings across multiple papers into themes"),
            _cap("fact_checking", "Cross-reference claims against prior literature"),
        ],
        metadata={"priority": 2},
    ),
    AgentProfile(
        id="research_code_reviewer", name="Code Reviewer",
        role="Research Code Review", tier=2, connector_type="internal",
        description="Reviews research code and experimental implementations for correctness and reproducibility",
        capabilities=[
            _cap("code_review", "Audit experimental codebases for bugs and reproducibility"),
            _cap("research", "Evaluate statistical methods and experimental design in code"),
            _cap("benchmark_analysis", "Run and validate benchmark results from research code"),
            _cap("summarization", "Produce code review reports with actionable findings"),
            _cap("fact_checking", "Verify code matches methodology described in papers"),
        ],
        metadata={"priority": 2},
    ),
    AgentProfile(
        id="benchmark_tracker", name="Benchmark Tracker",
        role="Benchmark Tracking", tier=2, connector_type="internal",
        description="Tracks state-of-the-art benchmark scores across AI, ML, and engineering domains",
        capabilities=[
            _cap("benchmark_analysis", "Monitor benchmark leaderboards and score changes"),
            _cap("web_search", "Search for new benchmark releases and evaluation suites"),
            _cap("data_collection", "Collect benchmark metadata, scores, and model details"),
            _cap("trend_analysis", "Track performance improvement rates across benchmarks"),
            _cap("summarization", "Report benchmark landscape changes and frontier shifts"),
        ],
        metadata={"priority": 2},
    ),
    AgentProfile(
        id="open_source_scout", name="Open Source Scout",
        role="OSS Discovery", tier=2, connector_type="internal",
        description="Discovers high-potential open source projects and assesses their strategic value",
        capabilities=[
            _cap("github_scan", "Scan GitHub for trending and emerging OSS projects"),
            _cap("web_search", "Search OSS communities, forums, and release announcements"),
            _cap("research", "Evaluate project health, license, and adoption trajectory"),
            _cap("trend_analysis", "Track momentum and contributor growth of OSS projects"),
            _cap("opportunity_scan", "Identify OSS projects suitable for integration or investment"),
        ],
        metadata={"priority": 2},
    ),
    AgentProfile(
        id="dataset_curator", name="Dataset Curator",
        role="Dataset Curation", tier=2, connector_type="internal",
        description="Discovers, evaluates, and curates high-quality datasets for training and analysis",
        capabilities=[
            _cap("data_collection", "Discover public and proprietary datasets across domains"),
            _cap("data_quality", "Evaluate dataset quality, coverage, and licensing"),
            _cap("web_search", "Search data portals, repositories, and research publications"),
            _cap("research", "Analyze dataset documentation and known limitations"),
            _cap("summarization", "Produce dataset evaluation reports with use-case recommendations"),
        ],
        metadata={"priority": 2},
    ),
]
