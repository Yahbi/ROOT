...
class ContentIngestion:
    ...
    def _read_pdf(path: Path) -> str:
        ...
        try:
            ...
            logger.debug("pdfplumber not installed, trying next PDF library")
        except Exception as exc:
        ...
        try:
            ...
            logger.debug("PyPDF2 not installed, trying next PDF library")
        except Exception as exc:
        ...
        try:
            ...
            logger.debug("PyMuPDF (fitz) not installed, trying next PDF library")
        except Exception as exc:
